...
tk.Label(root, text="first number", font=FONT,bg="lightblue").pack()
entry1 = tk.Entry(root, font=("Courier", 15,"bold"), width=20)
entry1.pack(pady=5)
tk.Label(root, text="second number", font=FONT,bg="lightblue").pack()
...
tk.Button(button_frame,text="x", width=5,command=lambda:calculate("*"),font=FONT,bg="lightpink").grid(row=0, column=2, padx=5)
